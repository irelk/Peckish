 ...
 */
public class DesssertServer extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_desssert_server, container, false);
        ...
        productsRecycler = view.findViewById(R.id.recyclerDessertServer);
        ...
        tableProducts.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot productSnapshot : dataSnapshot.getChildren())
                {
                    ...
                    Product product = productSnapshot.getValue(Product.class);
                    product.setKey(productSnapshot.getKey());
                    if (product.getType().equals("dessert")) {
    ...
    private void showUpdateFoodDialog(final String key, final Product product) {
        ...
        alertDialog.setTitle("Edit Dessert item");
