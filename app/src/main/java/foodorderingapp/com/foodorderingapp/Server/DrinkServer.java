 ...
 */
public class DrinkServer extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_drink_server, container, false);
        ...
        productsRecycler = view.findViewById(R.id.recyclerDrinksServer);
    ...
    private void showUpdateFoodDialog(final String key, final Product product) {
        ...
        alertDialog.setTitle("Edit drink item");
